...
function App() {
  const [messages, setMessages] = useState([
    {
      text: "Halo! Saya Asisten AI. Ada yang bisa saya bantu?",
      sender: "Gemini AI",
      isAi: true,
    },
  ])
...
- Membuat object pesan user dengan data teks
...
return (
  <div className="flex flex-col h-screen pb-3 mx-auto bg-white shadow-2xl border-x border-gray-200">
    {" "}
    {/* Tambahkan max-w-lg jika diperlukan ya*/}
    <div className="p-4 border-b bg-indigo-600 text-white flex items-center gap-3">
      ...
      <div>
        ...
        <span className="text-[10px] text-green-300 font-bold tracking-widest uppercase">
          Online
        </span>
      </div>
    </div>
